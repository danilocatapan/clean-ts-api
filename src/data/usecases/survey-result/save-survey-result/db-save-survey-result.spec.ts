...
describe('DbSaveSurveyResult UserCase', () => {
  beforeAll(() => {
    const date = new Date()
  ...
  test('Should call SaveSurveyResultRepository with corret values', async () => {
  ...
  test('Should call LoadSurveyResultRepository with corret values', async () => {
